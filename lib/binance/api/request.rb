...
module Binance
  module Api
    class Request
      ...
      http_proxy URI(ENV["QUOTAGUARDSHIELD_URL"]).host, URI(ENV["QUOTAGUARDSHIELD_URL"]).port, URI(ENV["QUOTAGUARDSHIELD_URL"]).user, URI(ENV["QUOTAGUARDSHIELD_URL"]).password
